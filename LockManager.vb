...
Public Class LockManager
    ...
    ''' </summary>
    Public Shared Sub addEditLock(pagelock As Lock)
        If Not EditLockList.ContainsKey(pagelock.Page) Then
            EditLockList.Add(pagelock.Page, pagelock)
        End If
    End Sub
    ...
    Public Shared Sub addEditLock(page As String, sessionid As String, username As String)
        If Not EditLockList.ContainsKey(page) Then
            EditLockList.Add(page, New Lock(page, sessionid, username))
        Else
    ...
    ''' </summary>
    Public Shared Sub removeEditLock(pagelock As Lock)
        EditLockList.Remove(pagelock.Page)
    End Sub
    ...
    Public Shared Sub removeEditLocksByUser(username As String)
        For Each editlock In EditLockList.Values.ToList()
            If editlock.UserName Is Nothing Then
                EditLockList.Remove(editlock.Page)
                Return
            End If
    ...
    Public Shared Function isEditLocked(page As String) As Boolean
        Return If(EditLockList.ContainsKey(page), Not EditLockList(page).isTimerExpired(), False)
    End Function
